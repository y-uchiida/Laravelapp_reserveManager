                ...
                <div class="max-w-2xl py-4 mx-auto">
                    ...
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea row="3" id="infomation" class="block mt-1 w-full"
                                name="infomation" required>{{ old('infomation') }}</x-textarea>
                        </div>
                        ...
                        <div class="md:flex justify-between items-end">
                            <div class="mt-4">
                                ...
                                <x-jet-input id="max_people" class="block mt-1 w-full" type="text" name="max_people"
                                    required />
                            </div>
                            <div class="flex space-x-4 justify-around">
                                <input type="radio" name="is_visible" value="1" id="is_visible" checked> 表示
                                <input type="radio" name="is_visible" value="0" id="is_visible"> 表示
                            </div>
